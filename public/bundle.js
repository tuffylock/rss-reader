...
/***/ function(module, exports, __webpack_require__) {
	...
	var RSSReader = __webpack_require__(166);

	document.addEventListener('DOMContentLoaded', function () {
	  root = document.getElementById('root');

	  ReactDOM.render(React.createElement(RSSReader, null), root);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Feed = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	ClientActions = __webpack_require__(168);
	FavoriteStore = __webpack_require__(175);

	FavoritesItem = __webpack_require__(193);
	...
	module.exports = React.createClass({
	  ...
	  render: function () {
	    var favorites = this.state.favorites.map(function (article, index) {
	      return React.createElement(FavoritesItem, { key: index, article: article });
	    }).reverse();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  fetchRSS: ApiUtil.fetchRSS,
	  fetchFavorites: ApiUtil.fetchFavorites,
	  addFavorite: ApiUtil.addFavorite,
	  removeFavorite: ApiUtil.removeFavorite
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClientActions = __webpack_require__(168);
	var RSSStore = __webpack_require__(195);

	var FeedItem = __webpack_require__(196);
	var Favorites = __webpack_require__(167);
	...
	module.exports = React.createClass({
	  ...
	  render: function () {
	    ...
	    this.state.articles.forEach(function (article, index) {
	      ...
	      articles.push(React.createElement(FeedItem, { key: index, article: article }));
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClientActions = __webpack_require__(168);
	var FavoriteStore = __webpack_require__(175);
	...
	module.exports = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'a',
	        { href: url, className: 'image-wrapper', style: image },
